    ...
    <CourseLayout>
      ...
      <QuizSection
        questions={[
          ...
          { question: "A trademark primarily protects:", options: ["Source code", "Brand identifiers like names, logos, and slogans", "Inventions", "Confidential formulas"], correctIndex: 1, explanation: "Trademarks protect words, symbols, and designs that identify the source of goods or services." },
          { question: "Plagiarism in computing is best described as:", options: ["Citing too many sources", "Presenting someone else's code or ideas as your own without attribution", "Using open-source libraries", "Reading a textbook"], correctIndex: 1, explanation: "Plagiarism is the unattributed use of another's work — including code, designs, or written content — and violates academic and professional ethics." },
          { question: "Software is generally protected by copyright as:", options: ["A patent automatically", "A literary work (the source code) from the moment of fixation", "A trademark", "A trade secret only"], correctIndex: 1, explanation: "Source code is treated as a literary work and is automatically copyrighted upon being fixed in a tangible medium." },
          { question: "Which IP protection is BEST for a novel cryptographic algorithm you want kept secret indefinitely?", options: ["Patent", "Trade secret", "Trademark", "Copyright only"], correctIndex: 1, explanation: "A patent requires public disclosure and expires; a trade secret can last indefinitely as long as secrecy is maintained — better when secrecy is feasible." },
          { question: "The Fair Use doctrine allows limited use of copyrighted material for purposes such as:", options: ["Commercial resale", "Criticism, comment, news reporting, teaching, and research", "Any personal use", "Bypassing license fees"], correctIndex: 1, explanation: "Fair Use permits limited use without permission for transformative purposes such as commentary, education, and research, evaluated by four statutory factors." },
        ]}
        scenarioQuestions={[
          {
