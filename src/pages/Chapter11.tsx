    ...
    <CourseLayout>
      ...
      <QuizSection
        questions={[
          ...
          { question: "Targeted advertising on social platforms relies primarily on:", options: ["Random selection", "User profiles built from behavioral, demographic, and interest data", "Phone-call recordings", "Postal addresses only"], correctIndex: 1, explanation: "Platforms build detailed user profiles from activity, interests, and demographics, enabling highly targeted ads." },
          { question: "Which is an ETHICAL concern with social-media advertising?", options: ["Faster load times", "Manipulation through micro-targeting and erosion of user privacy", "Better photo filters", "Free hosting"], correctIndex: 1, explanation: "Micro-targeted ads can manipulate vulnerable users and rely on extensive data collection that erodes privacy." },
          { question: "Crowdsourcing on social platforms is:", options: ["Hiring full-time staff", "Soliciting ideas, content, or solutions from a large online community", "A type of cyberattack", "Paid advertising"], correctIndex: 1, explanation: "Crowdsourcing taps a distributed online community to contribute ideas, content, funding, or labor." },
          { question: "Astroturfing refers to:", options: ["Outdoor sports content", "Fake grassroots campaigns where paid actors mimic genuine user support", "Eco-friendly hosting", "A type of social game"], correctIndex: 1, explanation: "Astroturfing manufactures the appearance of organic public support, deceiving users and distorting public discourse." },
          { question: "Best practice for businesses managing a social-media crisis is to:", options: ["Delete all negative comments", "Respond promptly, transparently, and honestly while correcting misinformation", "Ignore the issue", "Sue critics"], correctIndex: 1, explanation: "Transparent, timely, honest engagement preserves trust; censoring or ignoring usually amplifies the crisis." },
        ]}
        scenarioQuestions={[
          {
