    ...
    <CourseLayout>
      ...
      <QuizSection
        questions={[
          ...
          { question: "GDPR (General Data Protection Regulation) primarily protects:", options: ["Corporate trade secrets", "Personal data of individuals in the EU/EEA", "Government classified data", "Patent filings"], correctIndex: 1, explanation: "GDPR is an EU regulation protecting personal data and giving individuals rights over how their data is collected, used, and stored." },
          { question: "The principle of 'data minimisation' means:", options: ["Collecting as much data as possible", "Collecting only the data necessary for the stated purpose", "Storing data forever", "Sharing data widely"], correctIndex: 1, explanation: "Data minimisation, a core GDPR principle, limits collection to what is strictly necessary for the specified purpose." },
          { question: "Mass surveillance technologies raise concerns because they:", options: ["Improve internet speed", "Enable monitoring of populations without individualized suspicion, threatening civil liberties", "Are too expensive to deploy", "Cannot be turned off"], correctIndex: 1, explanation: "Mass surveillance can chill free expression, enable discrimination, and undermine democratic accountability when used without oversight." },
          { question: "A 'right to be forgotten' allows individuals to:", options: ["Erase their bank balance", "Request deletion of their personal data under certain conditions", "Avoid all taxes", "Delete other people's data"], correctIndex: 1, explanation: "Recognized in the EU, this right lets individuals request erasure of personal data when there is no compelling reason for continued processing." },
          { question: "Which is the BEST first response to a confirmed data breach involving personal data?", options: ["Hide it from regulators", "Contain the breach, assess impact, notify affected parties and regulators per law", "Delete all logs", "Blame the customer"], correctIndex: 1, explanation: "Responsible breach handling involves containment, impact assessment, and timely, transparent notification as required by law (e.g., GDPR's 72-hour rule)." },
        ]}
        scenarioQuestions={[
          {
