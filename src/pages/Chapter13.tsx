    ...
    <CourseLayout>
      ...
      <QuizSection
        questions={[
          ...
          { question: "Online anonymity is ETHICALLY valuable primarily because it:", options: ["Lets people commit crimes", "Protects whistleblowers, dissidents, and vulnerable users from retaliation", "Makes ads cheaper", "Speeds up the internet"], correctIndex: 1, explanation: "Anonymity enables free expression for those who would be silenced or harmed if identified — though it can also be misused." },
          { question: "Hate speech is generally distinguished from protected speech when it:", options: ["Expresses an unpopular opinion", "Incites violence or discrimination against a protected group", "Criticizes a public figure", "Uses strong language"], correctIndex: 1, explanation: "Most legal frameworks restrict speech that incites violence, discrimination, or hatred against protected groups, while protecting general unpopular opinions." },
          { question: "A 'chilling effect' refers to:", options: ["Cooling server rooms", "When users self-censor lawful speech out of fear of surveillance or punishment", "A type of malware", "Off-topic social posts"], correctIndex: 1, explanation: "A chilling effect occurs when the threat (real or perceived) of monitoring or sanction discourages legitimate speech." },
          { question: "Section-230-style intermediary liability rules typically:", options: ["Make platforms publishers of all user content", "Shield platforms from liability for most user-posted content while allowing moderation", "Forbid moderation", "Apply only to email"], correctIndex: 1, explanation: "Such rules treat platforms as conduits, granting limited liability protection while permitting good-faith moderation of harmful content." },
          { question: "Which is the BEST ethical response to harmful but legal speech on a platform you operate?", options: ["Ignore it entirely", "Apply transparent, consistently enforced community standards with appeal mechanisms", "Secretly shadow-ban all critics", "Sue the user"], correctIndex: 1, explanation: "Transparency, consistency, and due process (appeals) balance free expression with user safety better than opaque or arbitrary action." },
        ]}
        scenarioQuestions={[
          {
